...
<script setup>
	...
	import defaultCaptchaImage from '@/assets/common/images/verify-code.png'
	
	const store = useStore()
	const router = useRouter();
	
	const siteTitle = import.meta.env.VITE_APP_TITLE
	const redirectUrl = router.currentRoute.value.query.redirectTo || '/home'	
	const imgVerifyCode = ref(defaultCaptchaImage)
