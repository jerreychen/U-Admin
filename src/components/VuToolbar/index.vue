<template>
    <div class="toolbar d-flex row middle">
        ...
        <VuToolbarItem tooltip="数据仪表盘" icon="DataAnalysis" @click="handleDashboardClick" />
        
        <VuToolbarItem tooltip="清空缓存" v-if="showClearCache" icon="BrushFilled" @click="handleClearCacheClick" />
        
		<VuToolbarItem tooltip="全屏" icon="FullScreen" @click="handleFullscreenClick" />
 		
        <VuToolbarItem tooltip="消息中心" v-if="showNofication" icon="Bell" :badgeValue="notifyCount" @click="handleNotificationClick" />
...
<script setup>
    ...
    import VuToolbarItem from './VuToolbarItem.vue'
